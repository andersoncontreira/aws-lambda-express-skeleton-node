...
// Temporary for demostration
const CacheStorageService = require('./cache-storage-service')
  ...
  create (person) {
    ...
    return new Promise(function (resolve, reject) {
      if (self.validate(person)) {
        ...
        self.errorMessage = 'Unable to register the person.json'
        reject(new Error(self.errorMessage))
      }
    })
  }
